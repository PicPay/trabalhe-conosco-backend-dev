        ...
        <nav class="navbar navbar-static-top">
            <div class="container-fluid m-0">
                <a class="navbar-brand" href="index">
                    <img src="{{asset('assets/img/picpay.png')}}" class="admin_img" alt="logo">
                </a>
                        ...
                        <div class="user-settings no-bg">
                            <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                                <img src="{{asset('assets/img/admin.jpg')}}" class="admin_img2 img-thumbnail rounded-circle avatar-img"
                                     alt="avatar"> <strong>{{\Illuminate\Support\Facades\Auth::user()->nome}}</strong>
                                <span class="fa fa-sort-down white_bg"></span>
                            </button>
                            <div class="dropdown-menu admire_admin">
                                <a class="dropdown-item" href="/users/{{\Illuminate\Support\Facades\Auth::user()->id_auto}}/edit"><i class="fa fa-cogs"></i>
                                    Editar usuários</a>
